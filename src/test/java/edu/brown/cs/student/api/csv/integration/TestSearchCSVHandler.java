...
public class TestSearchCSVHandler {
  ...
  @Test
  public void testSearchNoToSearch() throws IOException {
    String filepath = "data/stars/ten-star.csv";
    // request loadcsv
    HttpURLConnection loadConnection = tryRequest("loadcsv?filepath=" + filepath);
    assertEquals(200, loadConnection.getResponseCode()); // successful *connection*
  ...
  @Test
  public void testSearchNoHasHeaders() throws IOException {
    String filepath = "data/stars/ten-star.csv";
    // request loadcsv
    HttpURLConnection loadConnection = tryRequest("loadcsv?filepath=" + filepath);
    assertEquals(200, loadConnection.getResponseCode()); // successful *connection*
  ...
  @Test
  public void testSearchIdentifierNoSpecifier() throws IOException {
    String filepath = "data/stars/ten-star.csv";
    // request loadcsv
    HttpURLConnection loadConnection = tryRequest("loadcsv?filepath=" + filepath);
    assertEquals(200, loadConnection.getResponseCode()); // successful *connection*
  ...
  @Test
  public void testSearchSpecifierNoIdentifier() throws IOException {
    String filepath = "data/stars/ten-star.csv";
    // request loadcsv
    HttpURLConnection loadConnection = tryRequest("loadcsv?filepath=" + filepath);
    assertEquals(200, loadConnection.getResponseCode()); // successful *connection*
